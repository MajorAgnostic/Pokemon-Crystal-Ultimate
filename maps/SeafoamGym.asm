...
SeafoamGym_MapEvents:
	...
	def_warp_events
	warp_event 17, 17, SEAFOAM_ISLANDS_ENTRANCE, 3

	def_coord_events
	coord_event 10, 14, SCENE_DEFAULT, QuizScientist1Scene
	coord_event  8, 22, SCENE_QUIZ2, QuizScientist2Scene2
	coord_event  8, 21, SCENE_QUIZ2, QuizScientist2Scene
	coord_event  4, 18, SCENE_QUIZ3, QuizScientist3Scene2
	coord_event  4, 17, SCENE_QUIZ3, QuizScientist3Scene
	coord_event  3, 10, SCENE_QUIZ4, QuizScientist4Scene2
	coord_event  2, 10, SCENE_QUIZ4, QuizScientist4Scene
	coord_event  7,  6, SCENE_QUIZ5, QuizScientist5Scene2
	coord_event  7,  5, SCENE_QUIZ5, QuizScientist5Scene

	def_bg_events

	def_object_events
	object_event 17,  4, SPRITE_BLAINE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SeafoamGymBlaineScript, -1
	object_event 18, 16, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SeafoamGymGuideScript, EVENT_SEAFOAM_GYM_GYM_GUIDE
	...
	object_event 24, 13, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerLinden, -1
	object_event 18, 22, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerCary, -1
	object_event 21, 15, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerDaniel, -1
	object_event 18, 10, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerLowell, -1
	object_event  7,  4, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, QuizScientist5, -1
	object_event  1, 10, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, QuizScientist4, -1
	object_event  4, 16, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, QuizScientist3, -1
	object_event  8, 20, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, QuizScientist2, -1
	object_event  9, 14, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, QuizScientist1, -1
