...
SafariZoneMainOffice2_MapEvents:
	...
	object_event 10,  4, SPRITE_JANINE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, JanineFinal, EVENT_NO_JANINE2
	...
	object_event  7, 15, SPRITE_VENOMOTH, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ForretressScript, EVENT_BEAT_BIKER_DWAYNE
