...
ViridianGym_MapScripts:
	def_scene_scripts
	scene_script .DummyScene0, SCENE_VIRIDIANGYM_DEFAULT
...
ViridianGym_MapEvents:
	...
	def_coord_events
	coord_event  4,  6, SCENE_VIRIDIANGYM_DEFAULT, DylanScene1
	coord_event  5,  6, SCENE_VIRIDIANGYM_DEFAULT, DylanScene2
