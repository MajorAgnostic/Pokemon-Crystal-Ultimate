...
UnionCaveB2F_MapEvents:
	...
	object_event 12, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, UnionCaveB2FMaxRevive, EVENT_UNION_CAVE_B2F_HYPER_POTION
