...
Route16Gate_MapScripts:
	def_scene_scripts
	scene_script .DummyScene, SCENE_16GATE_DEFAULT
...
Route16Gate_MapEvents:
	...
	def_coord_events
	coord_event  5,  4, SCENE_16GATE_DEFAULT, Route16GateBicycleCheck
	coord_event  5,  5, SCENE_16GATE_DEFAULT, Route16GateBicycleCheck
