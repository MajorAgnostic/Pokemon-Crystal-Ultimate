...
TeacherGroup:
	...
	db 72, CLEFABLE
			dw $D084, $D084, $D084, $D084, $D084
			db MOONLIGHT, CHARM, BELLY_DRUM, BODY_SLAM
	db 72, JUMPLUFF
			dw $D084, $D084, $D084, $D084, $D084
...
HikerGroup:
	...
	db 75, DONPHAN
			dw $D084, $D084, $D084, $D084, $D084
			db EARTHQUAKE, TOXIC, DOUBLE_EDGE, ROCK_SLIDE
	db 75, CROBAT
			dw $D084, $D084, $D084, $D084, $D084
			db LEECH_LIFE, SLUDGE_BOMB, TOXIC, FLY
	db 76, MACHAMP
			dw $D084, $D084, $D084, $D084, $D084
			db CROSS_CHOP, ROCK_SLIDE, SUBMISSION, FIRE_BLAST
	db -1 ; end
...
SageGroup:
	...
	db 34, HAUNTER
			dw $9411, $9411, $9411, $9411, $9411
			db MEAN_LOOK, DESTINY_BOND, CURSE, LICK
	db -1 ; end
...
MediumGroup:
	...
	db 32, GASTLY
			dw $9411, $9411, $9411, $9411, $9411
			db LICK, CONFUSE_RAY, CURSE, HYPNOSIS
	db 33, HAUNTER
			dw $9411, $9411, $9411, $9411, $9411
...
ExecutiveFGroup:
	...
	db 49, TENTACRUEL
			db $bb, $bb
			dw $5046, $5046, $5046, $5046, $5046
			db SURF, RAIN_DANCE, SLUDGE_BOMB, BARRIER
	db 50, VILEPLUME
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
