...
INCLUDE "maps/SilphCoDeliveryCenterB1F.asm"
INCLUDE "maps/SilphCoDeliveryCenter1F.asm"
INCLUDE "maps/BlackthornBurned.asm"
INCLUDE "maps/Route22Past.asm"
INCLUDE "maps/GiovanniHouse.asm"
INCLUDE "maps/SilverCaveExterior.asm"
