...
; BATTLE_ANIM_OBJ_POKE_BALL_BG
	battleanimobj ABSOLUTE_X, $00, BATTLE_ANIM_FRAMESET_POKE_BALL_1, BATTLE_ANIM_FUNC_POKEBALL_BG, PAL_BATTLE_OB_GREEN, BATTLE_ANIM_GFX_POKE_BALL_BG
...
; BATTLE_ANIM_OBJ_SHINY2
	battleanimobj RELATIVE_X, $88, BATTLE_ANIM_FRAMESET_SPARKLE, BATTLE_ANIM_FUNC_ENCORE_BELLY_DRUM, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_SPEED
