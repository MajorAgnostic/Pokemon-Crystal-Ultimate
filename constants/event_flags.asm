...
; Kanto hidden items
	...
	const EVENT_ENTIREFLYMAP
	const EVENT_FUCHSIA_ITEM
	const EVENT_ROUTE_35_HIDDEN_CANDY
	const EVENT_ROUTE_13_FH1
	const EVENT_ROUTE_13_FH2
	const EVENT_GOT_TM09_PSYCH_UP
	const EVENT_THUNDER_TM
	const EVENT_BLIZZARD_TM
	const EVENT_FIRE_BLAST_TM
	const EVENT_BEAT_KANTO_FEDERATION
	const EVENT_BEAT_TONY
	const EVENT_BEAT_NEV
	const EVENT_BEAT_STRAUSS
	const EVENT_BEAT_BUCK
	const EVENT_SILPDELIV_REVIVE
	const EVENT_SILPDELIV_HIDDEN_ULTRA_BALL
	const EVENT_SILPDELIV_FR
	const EVENT_SILPDELIV_MAX_REVIVE
	const EVENT_SILPDELIV_RARE_CANDY
	const EVENT_SILPDELIV_HIDDEN_FULL_HEAL
	const EVENT_BEAT_FED1_1
	const EVENT_GUY_FREED
	const EVENT_GUY_FREED2
	const EVENT_CRATES_MOVED
	const EVENT_SUSPICIOUS_BOOK
	const EVENT_BEAT_ALEXANDER
	const EVENT_DELIV_GATE_UNLOCKED
...
; New to Crystal
	...
	const EVENT_E4_MART
	const EVENT_ROUTE_39_METAL_COAT
	const EVENT_BLACKTHORNBURNED_LEFTOVERS
	const EVENT_SAFFRONCITY_MISTY
	const EVENT_SILVER_HIDDENGBJUICE
	const EVENT_SILVER_EXTERIOR_MAX_POTION
	const EVENT_SILVER_EXTERIOR_FULL_RESTORE
	const EVENT_SILVER_HIDDENRARECANDY
	const EVENT_SILVER_HIDDENMAXELIXIR
